      ...
      <div className="h-full w-full flex flex-col ">
        <div className="flex items-center text-[#4D5562] w-full gap-2 p-2 pb-4 border-b border-[#4D5562]">
          ...
          <select
            ...
            className={
              inputLang !== "si" && inputLang !== "fr" && inputLang !== "en"
        ...
        <textarea
          ...
          value={text}
          maxLength={500}
          className="text-[#CDD5E0] bg-transparent w-full h-full resize-none focus:outline-none mt-4 font-bold"
        ></textarea>
        <p className="text-[#4D5562] text-[12px] ml-auto mb-3">
          {text.length}/500
        </p>
